...
DEFINE_TEST(strcmp_match, ORDER_SECONDARY, -1, NOP, strcmp("hello", "hello"))
...
DEFINE_TEST(strncmp_submatch, ORDER_SECONDARY, -1, NOP, strncmp("hello", "hellish", 3))
DEFINE_TEST(strncmp_subnotmatch, ORDER_SECONDARY, -1, NOP, strncmp("hello", "hellish", 6))
DEFINE_TEST(strncmp_posret, ORDER_SECONDARY, 1, NOP, strncmp("abc", "a", 1))
